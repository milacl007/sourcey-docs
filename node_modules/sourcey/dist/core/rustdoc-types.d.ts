...
export declare const RUSTDOC_DIAGNOSTIC_CODES: {
    readonly FORMAT_VERSION_MISMATCH: "RUSTDOC_FORMAT_VERSION_MISMATCH";
    readonly INTRA_DOC_LINK_UNRESOLVED: "RUSTDOC_INTRA_DOC_LINK_UNRESOLVED";
    readonly MISSING_HTML_ROOT_URL: "RUSTDOC_MISSING_HTML_ROOT_URL";
    readonly AUTO_FELL_BACK_TO_SNAPSHOT: "RUSTDOC_AUTO_FELL_BACK_TO_SNAPSHOT";
    readonly NO_VIABLE_MODE: "RUSTDOC_NO_VIABLE_MODE";
    readonly HELPER_MISSING: "RUSTDOC_HELPER_MISSING";
    readonly HELPER_FAILED: "RUSTDOC_HELPER_FAILED";
    readonly INVALID_SNAPSHOT_SCHEMA: "RUSTDOC_INVALID_SNAPSHOT_SCHEMA";
    readonly NIGHTLY_NOT_FOUND: "RUST_NIGHTLY_NOT_FOUND";
    readonly RUSTUP_NOT_FOUND: "RUSTUP_NOT_FOUND";
};
export type RustdocDiagnosticCode = (typeof RUSTDOC_DIAGNOSTIC_CODES)[keyof typeof RUSTDOC_DIAGNOSTIC_CODES];
//# sourceMappingURL=rustdoc-types.d.ts.map